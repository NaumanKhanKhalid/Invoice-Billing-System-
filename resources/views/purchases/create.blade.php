...
<div class="max-w-3xl mx-auto space-y-5" x-data="{
  ...
  <div class="flex items-center gap-3"><a href="{{ route('purchases.index') }}" class="text-slate-400 hover:text-slate-600"><i data-lucide="arrow-left" class="w-5 h-5"></i></a><div><h1 class="text-2xl font-bold text-slate-900">New Purchase Order</h1><p class="text-sm text-slate-500">Record chicken purchase from supplier</p></div></div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-5">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
          ...
          <p class="text-xs text-slate-400 mt-1">Auto-filled from today's rate</p>
        </div>
        <div>
