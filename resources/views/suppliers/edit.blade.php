...
<div class="space-y-6">
  ...
  <div class="flex items-center gap-3">
    ...
    <div>
      <h1 class="text-xl font-bold text-slate-900">{{ __('forms.edit_supplier') }}</h1>
    ...
    <div class="grid grid-cols-3 gap-6">
          ...
          <div class="p-5 space-y-4">
            ...
            <div>
              ...
              <textarea name="address" rows="2"
                class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:ring-2 focus:ring-green-300 outline-none">{{ old('address',$supplier->address) }}</textarea>
            </div>
          </div>
        </div>
      ...
      <div class="space-y-4">
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div class="p-5">
            ...
            <textarea name="notes" rows="4"
              class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:ring-2 focus:ring-green-300 outline-none">{{ old('notes',$supplier->notes) }}</textarea>
          </div>
        </div>
        ...
        <button type="submit" class="w-full bg-green-600 hover:bg-green-700 text-white py-2.5 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 transition-colors">
          <i data-lucide="check-circle" class="w-4 h-4"></i> Update Supplier
        </button>
