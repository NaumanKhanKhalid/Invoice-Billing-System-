...
<div class="max-w-3xl mx-auto space-y-5">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Add Client</h1>
            <p class="text-sm text-slate-500 mt-0.5">Create a new client profile</p>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('clients.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="address" rows="2"
                          ...
                          placeholder="Street address, area...">{{ old('address') }}</textarea>
            </div>
