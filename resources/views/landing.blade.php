...
<nav class="fixed top-0 inset-x-0 z-50 bg-white/90 backdrop-blur border-b border-slate-100">
  <div class="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
    ...
    <a href="{{ route('admin.login') }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">Login</a>
  </div>
</nav>
...
<section id="contact" class="py-20 px-4 bg-green-600">
  <div class="max-w-xl mx-auto text-center text-white">
    ...
    <a href="https://wa.me/923143551819?text=Assalam%20o%20Alaikum!%20ShopSaas%20ke%20baare%20mein%20maloomat%20chahiye."
       target="_blank"
