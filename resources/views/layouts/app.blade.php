...
<body class="min-h-screen flex">
    ...
    <div class="flex-1 flex flex-col min-h-screen min-w-0">
        ...
        <div class="bg-purple-600 text-white text-sm font-medium px-4 py-2 flex items-center justify-between gap-3">
          ...
          <form method="POST" action="{{ route('impersonate.stop') }}">
            @csrf
            <button type="submit" class="inline-flex items-center gap-1.5 bg-white/20 hover:bg-white/30 text-white px-3 py-1 rounded-lg text-xs font-semibold transition-colors">
