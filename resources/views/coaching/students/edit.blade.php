  ...
  <form action="{{ route('coaching.students.update', $student) }}" method="POST" class="bg-white rounded-xl border border-slate-200 shadow-sm divide-y divide-slate-100">
    ...
    <div class="px-6 py-5 space-y-4">
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select name="status" required class="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
    ...
    <div class="px-6 py-5 space-y-4">
      ...
      <div>
        ...
        <textarea name="notes" rows="2" class="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">{{ old('notes', $student->notes) }}</textarea>
      </div>
    </div>
    ...
    <div class="px-6 py-4 flex gap-3">
      ...
      <button type="submit" class="flex-1 bg-green-600 text-white rounded-lg py-2 text-sm font-medium hover:bg-green-700">Save Changes</button>
    </div>
  </form>
</div>
@endsection
